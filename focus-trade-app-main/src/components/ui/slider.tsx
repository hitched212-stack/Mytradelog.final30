...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="block h-5 w-5 rounded-full border-2 border-primary/80 bg-background shadow-md ring-offset-background focus-visible:outline-none focus-visible:ring-0 disabled:pointer-events-none disabled:opacity-50" />
  </SliderPrimitive.Root>
));
