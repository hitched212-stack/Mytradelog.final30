    ...
    <section className="overflow-hidden pt-24 sm:pt-32 pb-12 sm:pb-20 relative" ref={sectionRef}>
      <div className="text-center max-w-7xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="reveal-on-scroll delay-200 flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 sm:mb-20 px-4">
          <button className="group relative overflow-hidden sm:w-auto transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_30px_-5px_rgba(255,255,255,0.5)] text-sm font-medium text-zinc-950 bg-white w-full border-transparent border rounded-lg py-3.5 px-8 shadow-[0_0_20px_-5px_rgba(255,255,255,0.3)]">
