...
export default function TermsOfServicePage() {
  ...
  return (
    <div ref={sectionsRef} className="bg-black min-h-screen">
      {/* Navbar */}
        ...
        <div className="space-y-12 sm:space-y-16">
          ...
          <section className="reveal-on-scroll">
            <h2 className="text-lg sm:text-xl font-medium text-white mb-4 sm:mb-6 flex items-center gap-3">
              <span className="flex items-center justify-center w-6 h-6 rounded bg-zinc-900 border border-white/10 text-xs text-zinc-500 font-mono">
                01
              </span>
              Acceptance of Terms
            </h2>
